...
#define nrn_init _nrn_init__InhSigma3Exp2Syn
#define _nrn_initial _nrn_initial__InhSigma3Exp2Syn
#define nrn_cur _nrn_cur__InhSigma3Exp2Syn
#define _nrn_current _nrn_current__InhSigma3Exp2Syn
#define nrn_jacob _nrn_jacob__InhSigma3Exp2Syn
#define nrn_state _nrn_state__InhSigma3Exp2Syn
#define _net_receive _net_receive__InhSigma3Exp2Syn 
#define state state__InhSigma3Exp2Syn 
...
#define relu relu_InhSigma3Exp2Syn
#define sigmoid_sat sigmoid_sat_InhSigma3Exp2Syn
#define sigmoid_thr sigmoid_thr_InhSigma3Exp2Syn
...
#define ltp_sigmoid_half ltp_sigmoid_half_InhSigma3Exp2Syn
 double ltp_sigmoid_half = -80;
#define ltp_theshold ltp_theshold_InhSigma3Exp2Syn
 double ltp_theshold = -77;
#define ltd_theshold ltd_theshold_InhSigma3Exp2Syn
 double ltd_theshold = -70;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "ltp_sigmoid_half_InhSigma3Exp2Syn", 1e-009, 1e+009,
 "ltp_theshold_InhSigma3Exp2Syn", 1e-009, 1e+009,
 "ltd_theshold_InhSigma3Exp2Syn", 1e-009, 1e+009,
 ...
 "ltd_theshold_InhSigma3Exp2Syn", "mV",
 "ltp_theshold_InhSigma3Exp2Syn", "mV",
 "ltp_sigmoid_half_InhSigma3Exp2Syn", "mV",
 "tau1", "ms",
 "tau2", "ms",
 "e", "mV",
 "ltd_sigmoid_half", "mV",
 ...
 "ltd_theshold_InhSigma3Exp2Syn", &ltd_theshold_InhSigma3Exp2Syn,
 "ltp_theshold_InhSigma3Exp2Syn", &ltp_theshold_InhSigma3Exp2Syn,
 "ltp_sigmoid_half_InhSigma3Exp2Syn", &ltp_sigmoid_half_InhSigma3Exp2Syn,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 InhSigma3Exp2Syn C:/Users/Wladek/Documents/GitHub/neuronpp_gym/compiled/mods0/inh_sigma3exp2syn.mod\n");
...
/*CVODE*/
 ...
 DA = DA  / (1. - dt*( ( - 1.0 ) / tau1 )) ;
 DB = DB  / (1. - dt*( ( - 1.0 ) / tau2 )) ;
 Dlearning_w = Dlearning_w  / (1. - dt*( - 1.0 )) ;
  return 0;
}
 /*END CVODE*/
 static int state (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) { {
    ...
    learning_w = learning_w + (1. - exp(dt*(- 1.0)))*(- ( 0.0 ) / ( - 1.0 ) - learning_w) ;
   }
  return 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "inh_sigma3exp2syn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "Inhibitory synapse\n"
