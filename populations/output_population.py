...
class OutputPopulation(Population):
    ...
    def make_conn(self, cell: Ebner2019AChDACell, source, source_loc=None, syn_num_per_source=1, delay=1, weight=1,
        ...
        # Add neuromodulators
        syns_ach = cell.make_sypanses(source=None, weight=weight, mod_name="SynACh", target_sec=heads, target_loc=1.0,
                                      delay=delay)
        syns_da = cell.make_sypanses(source=None, weight=weight, mod_name="SynDa", target_sec=heads, target_loc=1.0,
                                     delay=delay)
